...
module.exports = function () {
  $(document).ready(() => {
    ...
    $("#slider").on("select.flickity", (event, pointer) => {
      const preview = $("#slider .is-selected").attr("data-url");
      const name = $("#slider .is-selected").attr("data-name");
      const mine = $("#slider .is-selected").attr("data-mine");
